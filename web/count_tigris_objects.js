...
const { S3Client, ListObjectsV2Command } = require('./node_modules/@aws-sdk/client-s3');
...
async function countS3() {
  ...
  do {
    ...
    if (res.Contents) count += res.Contents.length;
    token = res.NextContinuationToken;
  } while (token);

  console.log(`🎯 Total Objects in Tigris S3 [typing-passages/]: ${count}`);
}
