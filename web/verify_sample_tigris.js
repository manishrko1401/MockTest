...
async function testFetch() {
  const testKeys = [
    'typing-passages/tm-ssc-cgl-typing-1.txt',
    'typing-passages/tm-rrb-ntpc-typing-1.txt',
    'typing-passages/tm-delhi-police-hcm-typing-1.txt'
  ];
  ...
  for (const k of testKeys) {
    try {
      ...
      console.log(`✅ S3 Key: ${k} -> ${text.length} chars: "${text.slice(0, 60)}..."`);
    } catch (e) {
